  ...
  return (
    <div className="pt-28 pb-16 bg-bg-base min-h-screen">
      ...
      <div className="w-full max-w-6xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        >
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-sm flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-600 text-lg">info@beachealth.com</p>
            </div>
        ...
        >
          <form action="https://formsubmit.co/info@beachealth.com" method="POST" className="flex flex-col gap-5 h-full justify-between">
            ...
            <div className="flex flex-col gap-2 mt-2">
              <label className="flex items-start gap-3 cursor-pointer">
                <input type="checkbox" name="sms_consent" value="yes" className="mt-1 w-4 h-4 text-brand-green bg-slate-50 border-slate-300 rounded focus:ring-brand-green" required />
